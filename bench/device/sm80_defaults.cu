...
static void BM_SM80_default_plus_mult_s32_srgemm_tt_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_plus_mult_s32_srgemm_tt_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_plus_mult_s32_srgemm_tt_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_plus_mult_s32_srgemm_tt_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_plus_mult_s32_srgemm_tn_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_plus_mult_s32_srgemm_tn_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_plus_mult_s32_srgemm_tn_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_plus_mult_s32_srgemm_tn_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_plus_mult_s32_srgemm_nt_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_plus_mult_s32_srgemm_nt_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_plus_mult_s32_srgemm_nt_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_plus_mult_s32_srgemm_nt_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_plus_mult_s32_srgemm_nn_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_plus_mult_s32_srgemm_nn_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_plus_mult_s32_srgemm_nn_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_plus_mult_s32_srgemm_nn_t)
    ->RangeMultiplier(2)->Range(256, 4096);
...
static void BM_SM80_default_min_plus_s32_srgemm_tt_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_plus_s32_srgemm_tt_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_min_plus_s32_srgemm_tt_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_plus_s32_srgemm_tt_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_min_plus_s32_srgemm_tn_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_plus_s32_srgemm_tn_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_min_plus_s32_srgemm_tn_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_plus_s32_srgemm_tn_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_min_plus_s32_srgemm_nt_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_plus_s32_srgemm_nt_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_min_plus_s32_srgemm_nt_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_plus_s32_srgemm_nt_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_min_plus_s32_srgemm_nn_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_plus_s32_srgemm_nn_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_min_plus_s32_srgemm_nn_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_plus_s32_srgemm_nn_t)
    ->RangeMultiplier(2)->Range(256, 4096);
...
static void BM_SM80_default_max_plus_s32_srgemm_tt_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_plus_s32_srgemm_tt_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_max_plus_s32_srgemm_tt_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_plus_s32_srgemm_tt_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_max_plus_s32_srgemm_tn_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_plus_s32_srgemm_tn_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_max_plus_s32_srgemm_tn_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_plus_s32_srgemm_tn_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_max_plus_s32_srgemm_nt_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_plus_s32_srgemm_nt_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_max_plus_s32_srgemm_nt_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_plus_s32_srgemm_nt_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_max_plus_s32_srgemm_nn_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_plus_s32_srgemm_nn_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_max_plus_s32_srgemm_nn_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_plus_s32_srgemm_nn_t)
    ->RangeMultiplier(2)->Range(256, 4096);
...
static void BM_SM80_default_min_max_s32_srgemm_tt_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_max_s32_srgemm_tt_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_min_max_s32_srgemm_tt_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_max_s32_srgemm_tt_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_min_max_s32_srgemm_tn_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_max_s32_srgemm_tn_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_min_max_s32_srgemm_tn_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_max_s32_srgemm_tn_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_min_max_s32_srgemm_nt_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_max_s32_srgemm_nt_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_min_max_s32_srgemm_nt_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_max_s32_srgemm_nt_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_min_max_s32_srgemm_nn_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_max_s32_srgemm_nn_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_min_max_s32_srgemm_nn_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_max_s32_srgemm_nn_t)
    ->RangeMultiplier(2)->Range(256, 4096);
...
static void BM_SM80_default_max_min_s32_srgemm_tt_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_min_s32_srgemm_tt_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_max_min_s32_srgemm_tt_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_min_s32_srgemm_tt_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_max_min_s32_srgemm_tn_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_min_s32_srgemm_tn_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_max_min_s32_srgemm_tn_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_min_s32_srgemm_tn_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_max_min_s32_srgemm_nt_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_min_s32_srgemm_nt_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_max_min_s32_srgemm_nt_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_min_s32_srgemm_nt_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_max_min_s32_srgemm_nn_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_min_s32_srgemm_nn_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_max_min_s32_srgemm_nn_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_min_s32_srgemm_nn_t)
    ->RangeMultiplier(2)->Range(256, 4096);
...
static void BM_SM80_default_min_mult_s32_srgemm_tt_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_mult_s32_srgemm_tt_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_min_mult_s32_srgemm_tt_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_mult_s32_srgemm_tt_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_min_mult_s32_srgemm_tn_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_mult_s32_srgemm_tn_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_min_mult_s32_srgemm_tn_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_mult_s32_srgemm_tn_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_min_mult_s32_srgemm_nt_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_mult_s32_srgemm_nt_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_min_mult_s32_srgemm_nt_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_mult_s32_srgemm_nt_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_min_mult_s32_srgemm_nn_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_mult_s32_srgemm_nn_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_min_mult_s32_srgemm_nn_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_min_mult_s32_srgemm_nn_t)
    ->RangeMultiplier(2)->Range(256, 4096);
...
static void BM_SM80_default_max_mult_s32_srgemm_tt_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_mult_s32_srgemm_tt_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_max_mult_s32_srgemm_tt_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_mult_s32_srgemm_tt_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_max_mult_s32_srgemm_tn_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_mult_s32_srgemm_tn_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_max_mult_s32_srgemm_tn_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_mult_s32_srgemm_tn_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_max_mult_s32_srgemm_nt_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_mult_s32_srgemm_nt_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_max_mult_s32_srgemm_nt_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_mult_s32_srgemm_nt_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_max_mult_s32_srgemm_nn_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_mult_s32_srgemm_nn_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_max_mult_s32_srgemm_nn_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_max_mult_s32_srgemm_nn_t)
    ->RangeMultiplier(2)->Range(256, 4096);
...
static void BM_SM80_default_or_and_s32_srgemm_tt_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_or_and_s32_srgemm_tt_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_or_and_s32_srgemm_tt_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_or_and_s32_srgemm_tt_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_or_and_s32_srgemm_tn_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_or_and_s32_srgemm_tn_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_or_and_s32_srgemm_tn_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_or_and_s32_srgemm_tn_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_or_and_s32_srgemm_nt_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_or_and_s32_srgemm_nt_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_or_and_s32_srgemm_nt_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_or_and_s32_srgemm_nt_t)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_or_and_s32_srgemm_nn_n(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_or_and_s32_srgemm_nn_n)
    ->RangeMultiplier(2)->Range(256, 4096);

///////////////////////////////////////////////////////////////////////////////

static void BM_SM80_default_or_and_s32_srgemm_nn_t(benchmark::State &state) {
  const auto N = static_cast<int>(state.range(0));
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
...
BENCHMARK(BM_SM80_default_or_and_s32_srgemm_nn_t)
    ->RangeMultiplier(2)->Range(256, 4096);
