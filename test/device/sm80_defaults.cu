...
TEST(SM80_default_plus_mult_srgemm, s32_tt_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::plus_mult<precision>;
...
TEST(SM80_default_plus_mult_srgemm, s32_tt_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::plus_mult<precision>;
...
TEST(SM80_default_plus_mult_srgemm, s32_tn_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::plus_mult<precision>;
...
TEST(SM80_default_plus_mult_srgemm, s32_tn_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::plus_mult<precision>;
...
TEST(SM80_default_plus_mult_srgemm, s32_nt_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::plus_mult<precision>;
...
TEST(SM80_default_plus_mult_srgemm, s32_nt_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::plus_mult<precision>;
...
TEST(SM80_default_plus_mult_srgemm, s32_nn_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::plus_mult<precision>;
...
TEST(SM80_default_plus_mult_srgemm, s32_nn_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::plus_mult<precision>;
...
TEST(SM80_default_min_plus_srgemm, s32_tt_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_plus<precision>;
...
TEST(SM80_default_min_plus_srgemm, s32_tt_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_plus<precision>;
...
TEST(SM80_default_min_plus_srgemm, s32_tn_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_plus<precision>;
...
TEST(SM80_default_min_plus_srgemm, s32_tn_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_plus<precision>;
...
TEST(SM80_default_min_plus_srgemm, s32_nt_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_plus<precision>;
...
TEST(SM80_default_min_plus_srgemm, s32_nt_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_plus<precision>;
...
TEST(SM80_default_min_plus_srgemm, s32_nn_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_plus<precision>;
...
TEST(SM80_default_min_plus_srgemm, s32_nn_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_plus<precision>;
...
TEST(SM80_default_max_plus_srgemm, s32_tt_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_plus<precision>;
...
TEST(SM80_default_max_plus_srgemm, s32_tt_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_plus<precision>;
...
TEST(SM80_default_max_plus_srgemm, s32_tn_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_plus<precision>;
...
TEST(SM80_default_max_plus_srgemm, s32_tn_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_plus<precision>;
...
TEST(SM80_default_max_plus_srgemm, s32_nt_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_plus<precision>;
...
TEST(SM80_default_max_plus_srgemm, s32_nt_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_plus<precision>;
...
TEST(SM80_default_max_plus_srgemm, s32_nn_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_plus<precision>;
...
TEST(SM80_default_max_plus_srgemm, s32_nn_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_plus<precision>;
...
TEST(SM80_default_min_max_srgemm, s32_tt_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_max<precision>;
...
TEST(SM80_default_min_max_srgemm, s32_tt_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_max<precision>;
...
TEST(SM80_default_min_max_srgemm, s32_tn_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_max<precision>;
...
TEST(SM80_default_min_max_srgemm, s32_tn_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_max<precision>;
...
TEST(SM80_default_min_max_srgemm, s32_nt_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_max<precision>;
...
TEST(SM80_default_min_max_srgemm, s32_nt_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_max<precision>;
...
TEST(SM80_default_min_max_srgemm, s32_nn_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_max<precision>;
...
TEST(SM80_default_min_max_srgemm, s32_nn_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_max<precision>;
...
TEST(SM80_default_max_min_srgemm, s32_tt_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_min<precision>;
...
TEST(SM80_default_max_min_srgemm, s32_tt_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_min<precision>;
...
TEST(SM80_default_max_min_srgemm, s32_tn_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_min<precision>;
...
TEST(SM80_default_max_min_srgemm, s32_tn_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_min<precision>;
...
TEST(SM80_default_max_min_srgemm, s32_nt_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_min<precision>;
...
TEST(SM80_default_max_min_srgemm, s32_nt_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_min<precision>;
...
TEST(SM80_default_max_min_srgemm, s32_nn_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_min<precision>;
...
TEST(SM80_default_max_min_srgemm, s32_nn_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_min<precision>;
...
TEST(SM80_default_min_mult_srgemm, s32_tt_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_mult<precision>;
...
TEST(SM80_default_min_mult_srgemm, s32_tt_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_mult<precision>;
...
TEST(SM80_default_min_mult_srgemm, s32_tn_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_mult<precision>;
...
TEST(SM80_default_min_mult_srgemm, s32_tn_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_mult<precision>;
...
TEST(SM80_default_min_mult_srgemm, s32_nt_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_mult<precision>;
...
TEST(SM80_default_min_mult_srgemm, s32_nt_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_mult<precision>;
...
TEST(SM80_default_min_mult_srgemm, s32_nn_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_mult<precision>;
...
TEST(SM80_default_min_mult_srgemm, s32_nn_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::min_mult<precision>;
...
TEST(SM80_default_max_mult_srgemm, s32_tt_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_mult<precision>;
...
TEST(SM80_default_max_mult_srgemm, s32_tt_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_mult<precision>;
...
TEST(SM80_default_max_mult_srgemm, s32_tn_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_mult<precision>;
...
TEST(SM80_default_max_mult_srgemm, s32_tn_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_mult<precision>;
...
TEST(SM80_default_max_mult_srgemm, s32_nt_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_mult<precision>;
...
TEST(SM80_default_max_mult_srgemm, s32_nt_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_mult<precision>;
...
TEST(SM80_default_max_mult_srgemm, s32_nn_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_mult<precision>;
...
TEST(SM80_default_max_mult_srgemm, s32_nn_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::max_mult<precision>;
...
TEST(SM80_default_or_and_srgemm, s32_tt_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::or_and<precision>;
...
TEST(SM80_default_or_and_srgemm, s32_tt_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::or_and<precision>;
...
TEST(SM80_default_or_and_srgemm, s32_tn_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::or_and<precision>;
...
TEST(SM80_default_or_and_srgemm, s32_tn_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::or_and<precision>;
...
TEST(SM80_default_or_and_srgemm, s32_nt_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::or_and<precision>;
...
TEST(SM80_default_or_and_srgemm, s32_nt_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::or_and<precision>;
...
TEST(SM80_default_or_and_srgemm, s32_nn_n) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::or_and<precision>;
...
TEST(SM80_default_or_and_srgemm, s32_nn_t) {
  using precision = int;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm80;
  using RingOp = cuasr::or_and<precision>;
