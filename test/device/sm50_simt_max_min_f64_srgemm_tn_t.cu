...
TEST(SM50_device_max_min_f64_srgemm_tn_t, 8x32x8_8x32x1_2x4_4x8_1x1) {
...
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 1)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 16x32x8_16x32x1_4x4_4x8_1x1) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 1)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 16x64x8_16x64x1_4x8_4x8_1x1) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
TEST(SM50_device_max_min_f64_srgemm_tn_t, 32x32x8_32x32x1_8x4_4x8_1x1) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
TEST(SM50_device_max_min_f64_srgemm_tn_t, 8x32x8_8x16x1_2x2_4x8_1x2) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 1)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 8x64x8_8x32x1_2x4_4x8_1x2) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
//       Threadblock:  16 x  32 x   8
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 2)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 16x32x8_16x16x1_4x2_4x8_1x2) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 1)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 16x128x8_16x64x1_4x8_4x8_1x2) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
//       Threadblock:  32 x  32 x   8
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 1)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 32x32x8_32x16x1_4x4_8x4_1x2) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 1)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 32x64x8_32x32x1_8x4_4x8_1x2) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
//       Threadblock:  32 x  32 x   8
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 2)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 32x32x8_16x32x1_4x4_4x8_2x1) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 1)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 64x32x8_32x32x1_8x4_4x8_2x1) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
//       Threadblock:  16 x  32 x   8
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 2)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 16x32x8_8x16x1_2x2_4x8_2x2) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
//       Threadblock:  16 x  64 x   8
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 2)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 16x64x8_8x32x1_2x4_4x8_2x2) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
//       Threadblock:  32 x  32 x   8
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 2)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 32x32x8_16x16x1_4x2_4x8_2x2) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
//       Threadblock:  32 x  64 x   8
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 2)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 32x64x8_16x32x1_4x4_4x8_2x2) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 1)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 32x128x8_16x64x1_4x8_4x8_2x2) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
//       Threadblock:  64 x  32 x   8
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 2)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 64x32x8_32x16x1_4x4_8x4_2x2) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 1)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 128x32x8_64x16x1_8x4_8x4_2x2) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 2)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 16x64x16_8x16x1_2x2_4x8_2x4) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 2)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 16x128x16_8x32x1_2x4_4x8_2x4) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
//       Threadblock:  32 x  32 x   8
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 2)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 32x32x8_16x8x1_2x2_8x4_2x4) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
//       Threadblock:  32 x  64 x   8
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 2)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 32x64x8_16x16x1_4x2_4x8_2x4) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
//       Threadblock:  32 x 128 x   8
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 2)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 32x128x8_16x32x1_4x4_4x8_2x4) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 1)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 32x256x8_16x64x1_4x8_4x8_2x4) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
//       Threadblock:  64 x  64 x   8
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 1)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 64x64x8_32x16x1_4x4_8x4_2x4) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 1)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 64x128x8_32x32x1_8x4_4x8_2x4) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
//       Threadblock:  32 x  32 x   8
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 2)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 32x32x8_8x16x1_2x2_4x8_4x2) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
//       Threadblock:  64 x  32 x   8
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 2)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 64x32x8_16x16x1_4x2_4x8_4x2) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
//       Threadblock:  64 x  64 x   8
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 2)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 64x64x8_16x32x1_4x4_4x8_4x2) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 0)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 128x64x8_32x32x1_8x4_4x8_4x2) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 1)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 256x32x8_64x16x1_8x4_8x4_4x2) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 2)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 32x64x16_8x16x1_2x2_4x8_4x4) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 2)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 32x128x16_8x32x1_2x4_4x8_4x4) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
//       Threadblock:  64 x  64 x   8
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 2)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 64x64x8_16x16x1_4x2_4x8_4x4) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
//       Threadblock:  64 x 128 x   8
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 2)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 64x128x8_16x32x1_4x4_4x8_4x4) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 2)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 128x32x16_32x8x1_4x2_8x4_4x4) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
...
//       Threadblock: 128 x  64 x   8
#if defined(CUASR_TEST_LEVEL) and (CUASR_TEST_LEVEL >= 1)
TEST(SM50_device_max_min_f64_srgemm_tn_t, 128x64x8_32x16x1_4x4_8x4_4x4) {
  using precision = double;
  using OpClass   = cutlass::arch::OpClassSimt;
  using SmArch    = cutlass::arch::Sm50;
